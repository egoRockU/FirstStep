  ...
  return (
    <section className="min-h-screen flex flex-col justify-start items-center py-10 text-center">
      ...
      <p className="max-w-xl p-5 font-semibold text-emerald-500">
        These are the ways you can fet in touch with me. Hope to hear from you
        soon ^_^
      </p>

      <div className="flex flex-col items-center justify-center gap-8 text-center">
        <div>
          <img src={mobile} alt="mobile info" className="w-32 h-32" />
        </div>
        <div>
        ...
        <div className="flex w-full items-center justify-evenly text-3xl text-emerald-700">
          {socials.map(({ link, icon }, key) => (
            <a
              ...
              className="duration-200 ease-in-out  hover:text-teal-400"
              key={key}
            >
              {icon}
            </a>
          ...
          {/* <form action="" method="POST">
            <div className="w-full">
              <div className="flex flex-col my-2">
                <label className="capitalize text-sm py-2 font-semibold text-emerald-500">
                  name
                </label>
                <input
                  type="text"
                  name="name"
                  className="border-2 rounded-lg p-3 flex focus:outline-none border-emerald-400
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  name="message"
                  rows="10"
                  className="border-2 rounded-lg p-3 flex focus:outline-none border-emerald-400 dark:bg-emerald-700 dark:text-white"
                ></textarea>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center">
              <button
                className="my-8 bg-gradient-to-r from-emerald-500 to text-emerald-950 px-6 py-3 font-semibold uppercase rounded-md tracking-wider cursor-pointer
