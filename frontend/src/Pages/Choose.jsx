          ...
          <div className=" h-[70%]">
            <div className="flex w-full h-full p-3">
              <div className="flex w-[80%] mx-auto">
                <div
                  className="w-1/2 h-[80%] flex flex-col justify-center items-center text-blue-500 border-[#444B88] border hover:bg-[#8B95EE] hover:text-white hover:w-[75%] duration-150"
