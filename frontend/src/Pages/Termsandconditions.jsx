        ...
        <div className="w-[90%] lg:w-[80%] mx-auto pt-20">
          ...
          <div className="w-[90%] lg:w-[60%] mx-auto pt-20 flex flex-col gap-3">
            <p className="flex flex-col">
              ...
              agreement, then you may not access the App or use any services.
            </p>
            <p className="flex flex-col gap-2">
              <span className="font-bold">2. User Accounts</span>
              <span>
                {" "}
                2.1. To access certain features of the App, you may be required
            ...
            <p className="flex flex-col gap-2">
              ...
              <span>
                ...
                portfolios, and personal information, that you submit or upload
                to FirstStep.
              </span>
              <span>
                ...
                perform your User Content in connection with the App and our
                business operations.
              </span>
            </p>
            <p className="flex flex-col gap-2">
              ...
              <span>
                4.1. You agree not to use the App for any unlawful purpose or in
                any way that violates these Terms.
              </span>
              <span>
