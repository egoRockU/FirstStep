...
function Create() {
  ...
  return (
    ...
    <input
      type="email"
      placeholder="Email"
      className="w-1/2 p-2 border rounded-md custom-input"
    />
    <input
      type="email"
      placeholder="Email"
    ...
    <button type="button" onClick={handleClick} className='w-32 text-stone-500 rounded-full bg-white p-2'>Register</button>

    <button type="button" onClick={handleClick} className='w-60 text-stone-500 rounded-full bg-white p-2'>Forgot Password?</button>
    </div>
    </div>
    </div>
