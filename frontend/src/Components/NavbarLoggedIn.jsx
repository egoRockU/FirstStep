      ...
      <div className="flex w-full lg:w-[80%] justify-between mx-auto relative">
        ...
        <div className="hidden lg:flex items-center gap-10">
          <ul className="flex h-full items-center space-x-10">
            <li className="text-lg md:text-xl font-medium text-black whitespace-nowrap cursor-pointer" onClick={clickResume}>Resume Builder</li>
            <li className="text-lg md:text-xl font-medium text-black whitespace-nowrap cursor-pointer" onClick={clickPortfolio}>
              Portfolio Builder
            </li>
            <li className="text-lg md:text-xl font-medium text-black cursor-pointer">For Employers</li>
          </ul>
        </div>
        <div>
